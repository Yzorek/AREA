...
function sendMailTwitch(mail, data) {
    return createMail(mail, "Stream start", "Stream start", `<!doctype html>
...
.mj-column-per-75 { width:75% !important; max-width: 75%; }
    ...
    @media only screen and (max-width:480px) {
      ...
      <img height="auto" src="https://s3-eu-west-1.amazonaws.com/topolio/uploads/62138805af80f/1645447187.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="228">
      ...
      <img height="auto" src="https://s3-eu-west-1.amazonaws.com/topolio/uploads/62138805af80f/1645447369.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150">
      ...
      <img height="auto" src="https://s3-eu-west-1.amazonaws.com/topolio/uploads/62138805af80f/1645447650.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="90">
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial; text-align: center;"><span style="font-size: 14px; font-family: Roboto, Tahoma, sans-serif;">${data.user_name}</span></p></div>
      ...
      <img height="auto" src="https://s3-eu-west-1.amazonaws.com/topolio/uploads/62138805af80f/1645447592.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="360">
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:2;text-align:left;color:#000000;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial; text-align: left;"><span style="font-size: 14px; font-family: Roboto, Tahoma, sans-serif;">${data.title}</span></p></div>
      ...
      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:auto;line-height:100%;">
        <tr>
          <td align="center" bgcolor="#B15CC3" role="presentation" style="border:none;border-radius:24px;cursor:auto;mso-padding-alt:9px 26px 9px 26px;background:#B15CC3;" valign="middle">
            <a href=${"https://www.twitch.tv/" + data.user_login} style="display: inline-block; background: #B15CC3; color: #ffffff; font-family: Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif; font-size: 17px; font-weight: normal; line-height: 21.25px; margin: 0; text-decoration: none; text-transform: none; padding: 9px 26px 9px 26px; mso-padding-alt: 0px; border-radius: 24px;" target="_blank">
              Go check it out !
            </a>
          </td>
        </tr>
...
function sendMailYoutube(mail, data) {
    return createMail(mail, "New Youtube Video", "New youtube video", null)
}
