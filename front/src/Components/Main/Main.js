...
import {
    ...
    GENERAL_DASHBOARD,
    GENERAL_PROFILE,
    SERVICE_SETTINGS, NOTIFICATION_CENTER
} from "./config";
                ...
                <Grid container item xs={12}>
                    ...
                    <Box component="main"
                        ...
                        {isLoading ? <Grid item container xs={12} style={{height: '100%'}} alignItems={'center'}
                            ...
                            <Route path={`NotificationCenter/*`} element={<SelectedRouter app={<NotificationCenter/>} idRoute={NOTIFICATION_CENTER} setIdSelectedDrawerButton={setIdSelectedDrawerButton} />}/>
                            <Route
                                path="*"
                                element={
