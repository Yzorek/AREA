        ...
        <Grid item xs={12} style={{marginTop: 25}}>
            <Paper elevation={1} sx={{p: 4}}>
                ...
                <Grid container item xs={8} direction={'column'}>
                    ...
                    <FormControlLabel
                        style={{marginLeft: 25}}
                        label={<Typography variant="subtitle1"> Notification when reaction is triggered </Typography>}
                        control={<Checkbox checked={checked[1]} color="secondary" onChange={handleChange2}/>}
                    />
                    <FormControlLabel
                        style={{marginLeft: 25}}
                        label={<Typography variant="subtitle1"> Status is visible by other users </Typography>}
                        control={<Checkbox checked={checked[2]} color="secondary" onChange={handleChange3}/>}
                    />
                    <FormControlLabel
                        style={{marginLeft: 25}}
                        label={<Typography variant="subtitle1"> Disable tutorial </Typography>}
                        control={<Checkbox checked={checked[3]} color="secondary" onChange={handleChange4}/>}
                    />
                    <FormControlLabel
                        style={{marginLeft: 25}}
                        label={<Typography variant="subtitle1"> Findable by other users </Typography>}
                        control={<Checkbox checked={checked[4]} color="secondary" onChange={handleChange5}/>}
                    />
                    <FormControlLabel
                        style={{marginLeft: 25}}
                        label={<Typography variant="subtitle1"> Settings 5 </Typography>}
                        control={<Checkbox checked={checked[5]} color="secondary" onChange={handleChange6}/>}
                    />
                    <FormControlLabel
                        style={{marginLeft: 25}}
                        label={<Typography variant="subtitle1"> Settings 6 </Typography>}
