    ...
    const handleServiceActivation = async (service) => {
        if (service.isActive) {
            ...
            if (service.name === 'Twitter') {
                ...
                window.location.href = "https://accounts.spotify.com/authorize?response_type=code&client_id=187c0fc794714871bbe61948b5232d56&scode=user-read-private%20user-read-email&redirect_uri=http://localhost:8082/App/SpotifyRedirect&state=generateRandomString(16)"
            } else {
                subUnsubToService(service, false);
            }
        }
