...
import { TWITTER, SPOTIFY, DISCORD, TWITCH, YOUTUBE, TELEGRAM } from "../Main/config";
...
export function PropFromId(id) {
    switch (id) {
        ...
        case (2):
            return ({icon: <SvgIcon component={SpotifyIcon} inheritViewBox/>, pageId: SPOTIFY, color: '#CC0063', name: 'Spotify'});
        case (3):
